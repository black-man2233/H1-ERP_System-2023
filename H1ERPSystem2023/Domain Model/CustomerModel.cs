...
namespace H1ERPSystem2023.DomainModel
{
    public class CustomerModel : PersonModel
    {
        ...
        public CustomerModel(CustomerModel customer) : base(customer.FirstName, customer.LastName, customer.Address,
        ...
        /// </summary>
        public CustomerModel(string firstName, string lastName, AddressModel address, string phoneNumber,
            string emailAddress, int customerNumber, DateTime? lastPurchaseDate)
