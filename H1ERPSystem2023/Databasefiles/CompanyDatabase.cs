    ...
    public partial class Database
    {
        ...
        void _addCompanies()
        {
            Companies.Add(new CompanyModel(1, "Virksomhed", "Vejej", "Nummer", "9900", "Aalborg,", "Denmark",
                Currency.DKK)); //Might be able to do Player selected by Currency currency, test later
            Companies.Add(new CompanyModel(2, "Virksomhed2", "Rørdalsvej", "Nummer2", "94114", "San Francisco",
                " America", Currency.USD)); //Might be able to do Player selected by Currency currency, test later
        }
        ...
        public void AddCompany(int id, string companyName, string street, string streetNumber, string postalCode,
        ...
        public void UpdateCompany(int ID, string companyName, string street, string streetNumber, string postalCode,
            string city, string country)
        {
            foreach (CompanyModel company in Companies)
            {
